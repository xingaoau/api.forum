...
class ContentTest extends TestCase
{
    ...
    public function testHtmlBodyContentWillBeClean()
    {
        $content = Content::create([
            ...
            'body' => '<h2>Hello</h2><br><p>Some text here.</p><script>alert("xss")</script>',
        ]);

        $this->assertSame('<h2>Hello</h2><br><p>Some text here.</p>', $content->body);
    }
